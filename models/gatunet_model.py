...
# This code is from https://github.com/bmild/nerf
...
class GatUNet(nn.Module):
    def __init__(self, in_channels, out_channels, num_heads, dropout,
        ...
        for i, ico_level in enumerate(ico_down_levels):
        ...
        for i, ico_level in enumerate(ico_down_levels[::-1]):
            if i < len(ico_down_levels) - 1:
    ...
    def forward(self, x, xyz_moving, face=None):
        ...
        if self.encoding_layers[0].conv1.in_channels == 20:
            no_pe = False
